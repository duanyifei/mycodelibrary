...
class DamatuApi():
    ...
    def getSign(self,param=b''):
        return (md5(self.KEY.encode("utf8") + self.username.encode("utf8") + param))[:8]
...
#print(dmt.decode('pictures/69.jpeg',200)) #上传打码
#print(dmt.decode('pictures/0349.bmp',200)) #上传打码
